    ...
    <el-dialog :title="title" :visible="isShow" width="30%" center @close="$emit('close')">
      <el-form :model="form" :rules="rules" ref="siteform" label-width="100px">
        <el-form-item label="发布内容" prop="content">
          <el-input v-model="form.content" placeholder="请输入" size="small" type="textarea" :rows="5" id="content" />
        </el-form-item>
        <el-form-item label="发布类型" prop="infotype">
          <el-select v-model="form.infotype" placeholder="请选择" id="infotype" size="small" style="width: 100%">
